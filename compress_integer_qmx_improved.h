/*
   ...
   (See:https://en.wikipedia.org/wiki/BSD_licenses)
        ...
        Improved by:
                ...
                long sequences of zeros are not allowed (but singles 0s are
   allowed)
*/
#pragma once
...
public:
  ...
  virtual size_t encode(void *encoded, size_t encoded_buffer_length,
                        const uint32_t *source, size_t source_integers);
  virtual void decode(uint32_t *decoded, size_t integers_to_decode,
